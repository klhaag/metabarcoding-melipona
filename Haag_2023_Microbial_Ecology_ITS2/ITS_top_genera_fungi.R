...
# fungal genera between colonies with different health status,
...
# this tests the significance of the differences in relative abundances of
# fungal genera between months, correcting for multiple comparisons
...
# this tests the significance of the differences in relative abundances of
# fungal genera between different locations, correcting for multiple comparisons

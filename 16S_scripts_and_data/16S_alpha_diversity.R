#This script contains the analysis of bacterial alpha diversity and forager weight per month, location and health status
...
ggplot(meta_alpha, aes(x=month, y=shannon, color=colony)) +
  ...
  labs(title="Bacterial SDI in all samples",
       x=NULL,
...
ggplot(meta_alpha, aes(x=month, y=shannon, color=disease)) +
  ...
  scale_x_discrete(limits=c("Jan", "Feb", "Mar", "Apr"),
                   labels=c("JAN", "FEB", "MAR", "APR")) +
  labs(title="Bacterial SDI in relation to disease",
       x=NULL,
       y="Shannon Diversity Index") +
  theme_classic()

#box plot of shannon index x health status
...
ggplot(meta_alpha, aes(x=disease, y=shannon, color=disease)) +
  ...
  scale_x_discrete(limits=c("FALSE", "TRUE"),
                   labels=c("Healthy", "Diseased")) +
  labs(title="Relationship between bacterial SDI and disease",
       x=NULL,
       y="Shannon Diversity Index") +
  theme_classic()
...
ggplot(meta_alpha, aes(x=disease, y=shannoneven, color=disease)) +
  ...
  scale_x_discrete(limits=c("FALSE", "TRUE"),
                   labels=c("Healthy", "Diseased")) +
  labs(title="Relationship between bacterial Eveness and disease",
       x=NULL,
       y="Eveness") +
  theme_classic()
...
ggplot(meta_alpha, aes(x=month, y=shannoneven, color=month)) +
  ...
  scale_x_discrete(limits=c("Jan", "Feb", "Mar", "Apr"),
                   labels=c("JAN", "FEB", "MAR", "APR")) +
  labs(title="Temporal changes in bacterial Eveness",
       x=NULL,
       y="Eveness") +
  theme_classic()
...
ggplot(meta_alpha, aes(x=month, y=shannon, color=month)) +
  ...
  scale_x_discrete(limits=c("Jan", "Feb", "Mar", "Apr"),
                   labels=c("JAN", "FEB", "MAR", "APR")) +
  labs(title="Temporal changes in bacterial SDI",
       x=NULL,
       y="Shannon Diversity Index") +
  theme_classic()
...
ggplot(meta_alpha, aes(x=weight, y=shannon, color=month)) +
  ...
  scale_color_manual(name=NULL,
                     ...
                     breaks=c("Jan", "Feb", "Mar", "Apr"),
                     labels=c("JAN", "FEB", "MAR", "APR")) +
  labs(title="Correlation between forager weight and bacterial SDI",
       x="Bee Weight (g)",
       y="Shannon Diversity Index") +
  theme_classic()

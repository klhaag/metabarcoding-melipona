# This script runs the NMDS of bray-curtis distances of bacterial community composition 
...
nmds <- read_tsv(file="raw_data/melipona16s.subsample.braycurtis.nmds.axes")
